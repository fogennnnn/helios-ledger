  ...
  <section id="features" aria-labelledby="features-heading">
    <div class="container">
      ...
      <div class="bento" role="list">
        ...
        <article class="bento-card wide" role="listitem" aria-labelledby="f-api">
...
curl https://ai.oooooooooo.se/api/records/<span class="k">{id}</span>/verify
        ...
        <article class="bento-card" role="listitem" aria-labelledby="f-sign">
          <span class="bento-icon" aria-hidden="true">🔑</span>
        ...
        <article class="bento-card" role="listitem" aria-labelledby="f-merkle">
          <span class="bento-icon" aria-hidden="true">🌳</span>
        ...
        <article class="bento-card" role="listitem" aria-labelledby="f-reward">
          <span class="bento-icon" aria-hidden="true">🏅</span>
        ...
        <article class="bento-card" role="listitem" aria-labelledby="f-consensus">
          <span class="bento-icon" aria-hidden="true">🤝</span>
        ...
        <article class="bento-card" role="listitem" aria-labelledby="f-oss">
          <span class="bento-icon" aria-hidden="true">📖</span>
  ...
  <script>
    ...
    document.querySelectorAll('section, .step, .bento-card, .usecase, .faq-item').forEach(el => {
      el.style.opacity = 0;
