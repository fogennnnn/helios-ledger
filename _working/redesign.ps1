# redesign.ps1 - Deploy clean redesign
# Run from C:\Users\fogen\HELIOS

Write-Host 'Updating site...' -ForegroundColor Cyan
...
git commit -m 'redesign: clean dark UI, Sora font, teal accent'
git push

Write-Host 'Done! Live at https://ai.oooooooooo.se in ~30s' -ForegroundColor Green