# update5.ps1 - Fixed animated terminal
# Run from C:\Users\fogen\HELIOS

Write-Host 'Deploying fixed terminal...' -ForegroundColor Cyan
  ...
  <div class="container">
    ...
    <div class="term-wrap">
      <div class="term-header">
        ...
        <div class="term-tabs">
          <button class="term-tab active" data-scene="0">health</button>
...
<script>
  ...
  (function() {
    var SCENES = [
      { label:'health', lines:[
        {t:'cmd', s:'curl https://ai.oooooooooo.se/api/health'},
        {t:'gap'},
        {t:'out', s:'{'},
        {t:'out', s:'  "status": "ok",',             hl:true, d:70},
        {t:'out', s:'  "service": "helios-ledger",',  d:60},
        {t:'out', s:'  "version": "1.0.0",',          d:60},
        {t:'out', s:'  "record_count": 4,',           hl:true, d:60},
        {t:'out', s:'  "timestamp": "2026-03-15T19:15:56Z"', d:60},
        {t:'out', s:'}', d:60}
      ]},
      { label:'submit', lines:[
        {t:'cmd', s:'curl -X POST https://ai.oooooooooo.se/api/records \\'},
        {t:'cmd', s:'  -H "Authorization: Bearer $TOKEN" \\'},
        {t:'cmd', s:'  -d \'{"content":"AI output text","model":"claude-sonnet-4"}\''},
        {t:'gap'},
        {t:'out', s:'{'},
...
git commit -m 'fix: animated terminal properly contained'
git push
